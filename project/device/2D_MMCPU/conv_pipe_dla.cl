...
// TIP:(Removed due to CPU calc)  channel lane_cols	fc_data_channel;
// TIP:(Removed due to CPU calc)  channel lane_cols	fc_weight_channel;
// TIP:(Removed due to CPU calc)  channel DPTYPE	fc_bias_channel;
// TIP:(Removed due to CPU calc)  channel channel_cols	chain_output_channels[LANE_NUM+1];

// TIP:(Removed due to CPU calc)  channel memrd_weight_configuration	fc_memrd_configuration_channel __attribute__((depth(3)));
// TIP:(Removed due to CPU calc)  channel memwr_configuration 		fc_memwr_configuration_channel __attribute__((depth(3)));
// TIP:(Removed due to CPU calc)  channel instruction			fc_instruction_channel __attribute__((depth(3)));
// TIP:(Removed due to CPU calc)  channel w_data			fc_output_channel;
