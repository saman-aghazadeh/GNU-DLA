...
typedef struct {
	...
	int data_t;
	int weight_n;
} memrd_data_deser_configuration;
...
channel memrd_data_dseser_configuration		memrd_data_deser_configuration_channel;
channel memrd_data_ser_configuration		memrd_data_ser_configuration_channel;
