...

{
	...
	for (int i = 0; i < config_size; i++) {
		...
		int conv_group_size_w = config[i].conv_group_size_w;
		int conv_group_size_h = config[i].conv_group_size_h;
		int conv_group_size_t = config[i].conv_group_size_t;
		...
		memrd_data_config.conv_group_size_w = conv_group_size_w;
		memrd_data_config.conv_group_size_h = conv_group_size_h;
		memrd_data_config.conv_group_size_t = conv_group_size_t;
