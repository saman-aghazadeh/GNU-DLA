...
int main(int argc, char** argv)
{
	...
	for (int layer = 0; layer < LAYER_NUM; layer++) {
		...
		int num_bricks_h = (layer_config[layer][data_h]+2*layer_config[layer][conv_padding]-layer_config[layer][weight_h]+1)/config[layer].conv_stride;
		int num_bricks_t = (layer_config[layer][data_t]+2*layer_config[layer][conv_padding]-layer_config[layer][weight_t]+1)/config[layer].conv_stride;
